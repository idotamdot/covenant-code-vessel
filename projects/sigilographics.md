...
When a client is confused, harmed, blocked, misled, overcharged, or misaligned:

1. Clarify the issue in plain language.
2. Identify the responsibility boundary.
3. Document the decision record.
4. Offer a correction, rollback, transfer, or refund path where appropriate.
5. Update client-facing language if confusion was foreseeable.
6. Update templates, proposals, or onboarding if the issue was systemic.
7. Preserve the repair record.
